...
const WGroupBaseInfo = ({ errtips, onChange, baseinfo, setEditorRef, onAvatarSave, onAvatarOpen, ...props }) => {
	...
	return (
       ...
       <div style={styles.left}>
       	<h3 style={ styles.panelTitle }>Groups <ContentAdd style={{float: 'right', cursor: 'pointer', marginRight: 16}} onClick={addGroup}/></h3>
       	<Divider/>
       	<List>
       		<ListItem
       ...
       <div style={styles.right}>
       	<h3 style={styles.panelTitle }>Member Information <ContentAdd style={{float: 'right', cursor: 'pointer', marginRight: 16}} onClick={addGroup}/></h3>
       	<Divider/>
       	<SelectField
